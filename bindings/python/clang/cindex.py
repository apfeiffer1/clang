...
class Cursor(Structure):
    ...
    #-ap: added this:
    def getCursorSemanticParent(self):
        """
        Determine and return the semantic parent of the given cursor
        """
        if not hasattr(self, '_getCursorSemanticParent'):
            self._getCursorSemanticParent = Cursor_getCursorSemanticParent(self)
        return self._getCursorSemanticParent
    #-ap: end
...
#-ap: added this one:
Cursor_getCursorSemanticParent = lib.clang_getCursorSemanticParent
Cursor_getCursorSemanticParent.argtypes = [Cursor]
Cursor_getCursorSemanticParent.restype = Cursor
Cursor_getCursorSemanticParent.errcheck = Cursor.from_result
#-ap: end
